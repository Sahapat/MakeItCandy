...
public class TopieStateSelect : MonoBehaviour
{
    ...
    private TopieMachine topieMachine = null;
    ...
    {
        if (!pause.isPause && !topieMachine.isWorking)
        {
            isShow = true;
            canDrag = true;
    ...
    private void OnMouseUp()
    {
        if (selected != -1)
        {
            ...
            {
                case 0:
                    topieMachine.flavorState = sugarFlavor.Orange;
                    break;
                case 1:
                    topieMachine.flavorState = sugarFlavor.PineApple;
                    break;
                case 2:
                    topieMachine.flavorState = sugarFlavor.Stawberry;
                    break;
                case 3:
                    topieMachine.flavorState = sugarFlavor.Grape;
                    break;
            }
        }
        Reset();
